    ...
    <section id="about" className="about">
      ...
      <div className="about-container">
        ...
        <div className="about-content" data-reveal="fade-left" data-delay="0.2">
          <span className="about-tag">FULL-STACK WEB ENGINEER</span>
          <h3>Crafting Scalable Digital Products with Clean Architecture</h3>
          <p>
            I&apos;m Muhammad Akmal, a full-stack JavaScript engineer who builds web
            applications from the ground up — database schema design, RESTful APIs,
            server-side logic, and responsive user interfaces.
          </p>
          <p>
        ...
        >
          ...
          >
            ...
            <div className="modal-body">
              ...
              <h2 id="modal-title">Muhammad Akmal — Developer Profile</h2>
              <p className="lead">
              ...
              <div className="modal-section">
                <h4><FiCode className="section-icon" /> What I Build</h4>
                <p>
              ...
              <div className="modal-section">
                <h4><FiAward className="section-icon" /> Engineering Mindset</h4>
                <p>
              ...
              <div className="modal-section">
                <h4><FiCheckCircle className="section-icon" /> Technical Stack Matrix</h4>
                <ul className="skill-list">
                  <li><strong>Next.js 14:</strong> Server-Side Rendering (SSR), App Router, dynamic API routes</li>
                  <li><strong>React 18:</strong> Reusable component design, custom hooks, context state sync</li>
                  <li><strong>Node.js &amp; Express:</strong> RESTful APIs, JWT authentication, role guards</li>
                  <li><strong>MongoDB &amp; Mongoose:</strong> Document modeling, indexing, schema validations</li>
                  <li><strong>Styling &amp; UX:</strong> Glassmorphic UI design, CSS keyframe animations, mobile-first responsiveness</li>
                </ul>
              </div>
